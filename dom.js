...
//Radio button=> lets learn how to write the javaScript for radio buttons
...
//     : `You have not selected any size`;
// });

//check box=>lets learn how to use js to test if checkbox is checked or not, get the value of selected checkboxes
//and select unselect all the checkboxes
// const checked = document.querySelector("#accept");
...
//Add/Remove Options=>lets learn how to dynamically add or remove options from the selected element in js
//construct a new option using Dom method
...
//Removing Items from <select> element conditionally=>lets learn how to use js to remove items from select element based on a condition
// const btn = document.querySelector(".btn");
...
//Handling change event=> the input element fires the change event one it losses focus, the radio button, checkbox, and select elements fire the change event after they have been selected
